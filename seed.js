...
const fs = require("fs");
const groupsSqlInsert = fs.readFileSync("./postgres-data/data/seedGroups.sql").toString();
const userGroupsSqlInsert = fs.readFileSync("./postgres-data/data/seedUserGroups.sql").toString();
const usersSqlInsert = fs.readFileSync("./postgres-data/data/seedUsers.sql").toString();
const salesSqlInsert = fs.readFileSync("./postgres-data/data/seedSales.sql").toString();
